/*
Initialisation :
BinaryTrie <int,max_log>b;
Operations :
add(x) : add x to trie
del(x) : remove x from trie
find(x).first : returns true if x in trie
get_kth(k).first : returns kth element from smallest number
get_maximum().first : returns maximum element
get_minimum().first : returns minimum element
operate_xor(x) : xor every element with x
*/
