// To solve a question for all possible nodes u
...
def dfs(node, parent=-1):
  ...
  for child in graph[node]:
    if child != parent:
      nodeDP = nodeDP + max(dfs(child, node), 0) [Merge Into]
  return nodeDP + 2 * color[node] - 1 [Finalise Merge]
print(dfs(u))

To this :
using Aggregate = int; [The struct we are using to store all the data]
using Value = int; [Same as Aggregate]

// & is optional in the merge_into & finalize_merge
